    ...
    <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-6 text-slate-800">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-5 text-xs text-blue-900 flex items-start gap-3">
        ...
        <div className="space-y-1">
          <div className="font-bold text-sm">Halaman Manajemen Penuh Master Data (Standar Nasional)</div>
          <p className="text-blue-800 leading-relaxed">
            Halaman ini disiapkan untuk pengelolaan CRUD parameter global sistem: taksonomi mangrove, lamun, terumbu karang, dan nilai konversi karbon.
          </p>
          <div className="pt-2">
            <button
