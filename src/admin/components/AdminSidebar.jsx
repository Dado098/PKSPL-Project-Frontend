...
export const AdminSidebar = ({
  ...
  const userEmail = user?.email || 'admin@pkspl.ipb.ac.id';
  const userRole = user?.role?.nama_role || 'Super Admin';
  const userInstitution = user?.institusi || 'PKSPL IPB University';
  ...
  return (
    <>
      ...
      >
        ...
        {/* ----------------------------------------------------------------- */}
        <div ref={profileRef} className="relative p-3 border-t border-slate-800 bg-slate-950/60 shrink-0">
            ...
            >
              ...
              <div className="p-3.5 bg-slate-900/90 border-b border-slate-800 flex items-center gap-3">
                ...
                <div className="leading-tight overflow-hidden">
                  ...
                  <div className="text-[11px] text-blue-400 font-medium truncate">{userEmail}</div>
                  <div className="text-[10px] text-slate-400 mt-0.5 truncate">{userInstitution}</div>
                </div>
              </div>
