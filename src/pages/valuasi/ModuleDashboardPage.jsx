...
export const moduleCategories = [
  {
    ...
    modules: [
      ...
      { id: 'genetic-resources', name: 'Genetic Resources', records: 1, icon: 'dna' },
    ],
  },
  {
    category: 'Regulating',
    ...
    modules: [
      { id: 'hpm', name: 'HPM', records: 6, icon: 'building' },
      { id: 'abm', name: 'ABM / Defensive Expenditure', records: 5, icon: 'shield' },
  ...
  },
  {
    ...
    modules: [
      { id: 'tcm', name: 'TCM', records: 8, icon: 'briefcase' },
      { id: 'cvm', name: 'CVM', records: 10, icon: 'chart' },
      { id: 'choice-experiment', name: 'Choice Experiment', records: 8, icon: 'experiment' },
    ],
  },
]
...
export function ModuleIcon({ type, color }) {
  ...
  return (
    <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${bgColors[color]}`}>
      {iconMap[type] || iconMap.clipboard}
    </div>
  )
}
...
function ModuleDashboardPage() {
  ...
  const projectName = projectNames[projectId] || 'Proyek'
      ...
      <div className="flex-1 px-4 md:px-8 lg:px-12 py-6 max-w-7xl mx-auto w-full">
        ...
        <div className="mb-6">
          <h1 className="text-lg md:text-xl font-bold text-gray-900">
            Status Modul Proyek : <span className="text-[#1a56db]">{projectName}</span>
          </h1>
          <p className="text-sm text-gray-500 mt-1">Status : Draft</p>
        </div>
                ...
                >
                  ...
                  <div className="p-4 pb-3">
                    <div className="flex items-start justify-between mb-1">
                      ...
                      <span className="px-2.5 py-0.5 bg-green-100 text-green-700 text-[10px] font-bold rounded-full flex-shrink-0">
                        Aktif
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="px-4 pb-4 mt-auto">
                    ...
                    <button
                      ...
                      className={`w-full py-2 border rounded-lg text-xs font-semibold transition-all duration-200 cursor-pointer hover:shadow-sm active:scale-[0.97] ${
                        cat.color === 'green'
